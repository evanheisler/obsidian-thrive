...
metadata: 
  ...
  modified: 2026-07-31T17:11:56.565Z
---
...
**How to apply:** when an executor returns anything other than SHIPPED/PARKED (e.g. "waiting for bots"), treat it as stalled: poll the PR yourself (claude[bot] review — the only bot on a draft; Codex fires only after the human opens the PR, 2026-07-31) and SendMessage the executor to run its review loop the moment the review exists. Before accepting a SHIPPED that claims the bot never reviewed, re-fetch this turn ([[feedback-refetch-before-asserting-state]], [[codex-review-posts-as-github-actions-comment]]).
