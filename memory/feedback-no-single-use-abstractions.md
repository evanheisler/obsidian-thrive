...
**How to apply:** when decomposing a screen, inline simple elements onto shared primitives with props (copy, onPress, variant); create a screen-specific component only when it's a genuine composite or reused. This is codified as an anti-pattern in the patient conventions ([[home-revamp-toggle-user-opt-in]] project). Check executor output for it.
