...
- [[ungrounded-proposals-postmortem]] — fabricated light-mode requirement, hearsay GUI-upload workaround, mechanism-less branch pitch that didn't fix the actual blocker, unchecked `tokensPkg` contents: solutions stated before verifying the mechanism or the binding constraint. **Read before proposing any fix, workaround, or issue contract.**
